...
class ContentController extends Controller
{
    ...
    public function page($page)
    {
        ...
        if ($page == 'home') {
            ...
            $banner = DB::table('banner')->orderby('sort', 'asc')->paginate(9);
            $data = ['page' => 'Home', 'logo_web' => $logo_web, 'banner' => $banner];
            return view('page.admin.content', ['data' => $data, 'userinfo' => $this->userinfo()]);
        ...
        if ($request->post()) {
            ...
            if ($page == 'home') {
                ...
                if (isset($request->img)) {
                    ...
                    // $file_upload = ['filename' => $_FILES['img']['name'], 'tmp_name' => $_FILES['img']['tmp_name'], 'folder' => 'upload/admin/logo_web/images'];
            ...
            } else if ($page == 'email_order' || $page == 'email_subscription' || $page == 'email_registration') {
    ...
    public function updatesort(Request $request){
        ...
        $count = sizeof($request->sort_list_arr);
        for($i=0;$i<$count;$i++){
            $result = DB::table('banner')->where('banner_id',$request->sort_list_arr[$i])->update(['sort'=>$i]);
        }
        if (isset($result)) {
