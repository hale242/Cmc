...
class WishlistController extends Controller
{
    ...
    public function index() {
      ...
      $detail = Wishlist::select('wishlist.wishlist_id','wishlist.created_at as date_create','course.course_id','course.course_name','course.course_price','course.course_view','course.course_teacher_id','user.first_name','user.last_name')
    ...
    public function addwilish(Request $request){
        ...
        if($user_id==''){
            ...
            $chekwishlish = Wishlist::where('course_id',$course_id)->where('user_id',$user_id)->count();
