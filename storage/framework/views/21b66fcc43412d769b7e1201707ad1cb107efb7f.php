                                ...
                                <div class="col-xs-12 col-md-12" style="margin-top:20px;padding:20px;">
                                    <div class="table-responsive">
                                        <table class="table table-striped b-t b-light" cellspacing="0" width="100%">
                                            ...
                                            <?php if(sizeof($data['detail']['mycourse'])!=0): ?>
...
<?php echo $__env->make('layouts.member.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/intervision.in/public_html/ezlearn/resources/views/page/member/dashboard.blade.php ENDPATH**/ ?>