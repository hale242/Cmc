<div class="modal fade bd-example-modal-lg" id="modal_create_lesson" tabindex="-1" role="dialog"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control detail" id="detail" name="detail" rows="5" maxlength="1000"></textarea>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="form-group">
                                <label class="col-form-label">Upload file: <span class="text-danger">(Upload a maximum of 10 mb per file.)</span></label>
...
<div class="modal fade bd-example-modal-lg" id="modal_create_banner_slide" tabindex="-1" role="dialog"
    aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form name="form_create_banner_slide" id="form_create_banner_slide" method="post">
                <?php echo csrf_field(); ?>
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><b><i class="fa fa-edit"></i> New Banner Slide</b>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <p class="text-danger">Only support jpeg, jpg, png files. || Upload file a maximum of 3
                                    mb & size 1920*695.</p>
                            </div>
                            <div class="form-group">
...
<script type="text/javascript">
    ...
    Dropzone.options.documentDropzone = {
        url: "<?php echo e(url('api/admin/course/lesson/upload')); ?>",
        width: 300,
        height: 300,
        // maxFilesize: 10, // MB
        ...
        headers: {
            ...
            $.ajax({
                    type: 'POST',
                    url: "<?php echo e(url('api/admin/course/lesson/upload/delete')); ?>",
                    data: "name="+name,
                    dataType: 'html'
                });
        ...
        init: function () {
            ...
            <?php if(isset($project) && $project->document): ?>
                var files = <?php echo json_encode($project->document); ?>
...
var url_api = "<?php echo e(url('api/admin/course/Lesson/action')); ?>";
...
var url_api = "<?php echo e(url('api/admin/content/banner/action')); ?>";
 ...
 $.ajax({
    ...
    if(data.result==true){
      ...
      if (result.value) {
        window.location = '<?php echo e(url('admin/content/home')); ?>';
      }
    })
...
<?php /**PATH /home/admin/domains/intervision.in/public_html/ezlearn/resources/views/layouts/admin/modal.blade.php ENDPATH**/ ?>