...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(".select2_category_data").select2({
            ajax: {
                url: "<?php echo e(url('api/admin/category/getdata')); ?>",
            ...
            $.get(url_div, function(data) {
                $.each(data, function(k, v) {
                    ...
                    $("#lesson_file").append('<div class="col-md-4">' +
                        '<a target="_blank" data-fancybox="gallery_lession' + v['lesson_id'] + '" style="border: 1px solid #ccc;padding: 5px;margin-right: -8px;margin-bottom: 5px;" href="<?php echo e(asset('
...
<script type="text/javascript">
    $(document).on('click', '.SubMenu', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/menusystem/submenu/')); ?>" + "/" + id,
            success: function(data) {
...
<script type="text/javascript">
    $(document).on('click', '.EditSubMenu', function() {
        ...
        $.ajax({
            url: "<?php echo e(url('admin/menusystem/getdatasubmenu/')); ?>" + "/" + id,
            success: function(data) {
                var res = data.content;
...
</script><?php /**PATH C:\xampp\htdocs\cmc\resources\views/layouts/admin/javascripts.blade.php ENDPATH**/ ?>