    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"><a href="<?php echo e(url('admin/products/'.strtolower($data['page']))); ?>"><?php echo e($data['page']); ?></a>
                </li>
            </ul>
            <?php if($data['page']=='Main'): ?><?php $title = 'Products';?><?php else: ?><?php $title = $data['page'];?><?php endif; ?>
            <div class="m-b-md">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                ...
                                <div class="col-lg-12 text-right">
                                    <a href="<?php echo e(url('admin/products/'.strtolower($data['page']).'/add')); ?>"
                                        class="btn btn-primary" title="Add"><i class="fa fa-plus"></i> Create</a>
                                </div>

                                <br><br><br>

                                <form action="<?php echo e(url('admin/products/'.$data['page']).'/search'); ?>" method="get"
                                    ...
                                    <div class="col-sm-6 m-b-xs">
                                        ...
                                        <div class="col-sm-7">
                                            <label for="txt_search">Product</label>
                                    ...
                                    <div class="col-sm-12 m-t">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="<?php echo e(url('admin/products/'.strtolower($data['page']))); ?>">
                            ...
                            <div class="table-responsive">
                                ...
                                <?php echo $__env->make('page.admin.include.products.view', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php elseif($data['type']=='form'): ?>
                                <?php echo $__env->make('page.admin.include.products.form', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php else: ?>
                                <?php echo $__env->make('page.admin.include.products.show', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endif; ?>
                            </div>
                        </section>
                </div>
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/intervision.in/public_html/ezlearn/resources/views/page/admin/products.blade.php ENDPATH**/ ?>