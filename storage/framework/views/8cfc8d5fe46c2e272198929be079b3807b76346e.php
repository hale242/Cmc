         ...
         <div class="mu-course-content-area">
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <h3 class="text-center hidden-sm hidden-md hidden-lg"><b><span class="text-blue">TRAINING</span> COURSE</b></h3>
                ...
                <aside class="mu-sidebar">
                    ...
                    <div class="text-center  hidden-sm hidden-md hidden-lg">
                        <div class="col-xs-6 border-filter filter-btn"><i class="fa fa-filter" aria-hidden="true"></i> Filter</div>
                        <div class="col-xs-6 border-filter sort-btn"><i class="fa fa-sort" aria-hidden="true"></i> Sort by</div>
                    </div>

                    <!-- start single sidebar -->
                    <div class="col-md-12 hidden-xs side-search-bar">
                        ...
                        ?>
                            ...
                            <div class="boxchoice">
                                <label for="cbx<?php echo e($value->category_id); ?>" class="label-cbx">
                                    <input id="cbx<?php echo e($value->category_id); ?>" name="choice_pretest[<?php echo e($value->category_id); ?>]" type="checkbox" class="check_cat invisible" value="<?php echo e($value->category_id); ?>" <?php if(isset($data['idcate'][0])){ if($data['idcate'][0]==$value->category_id){ echo "checked"; } } ?> >
                                    <div class="checkbox">
              ...
              <div class="col-md-9">
                ...
                <div class="mu-course-container">
                  <div class="row">
                    ...
                    <div class="sort-bar col-xs-12 col-md-3 pull-right hidden-xs">
...
<?php echo $__env->make('layouts.member.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cmc\resources\views/page/member/course.blade.php ENDPATH**/ ?>