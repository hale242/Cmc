    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <div class="m-b-md">
                ...
                <small>Welcome back, Cmc Elearning</small>
            </div>
            ...
            <section class="panel panel-default">
                <div class="row m-l-none m-r-none bg-light lter">
                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                        ...
                        <a class="clear" href="#">
                            <span class="h3 block m-t-xs"><strong><?php echo e($data['customer']); ?></strong></span>
                            <small class="text-muted text-uc">Customer</small>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                        ...
                        <a class="clear" href="#">
                            <span class="h3 block m-t-xs"><strong id="bugs"><?php echo e($data['order']); ?></strong></span>
                            <small class="text-muted text-uc">Orders</small>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                        ...
                        <a class="clear" href="#">
                            <span class="h3 block m-t-xs"><strong id="firers"><?php echo e($data['course']); ?></strong></span>
                            <small class="text-muted text-uc">Course</small>
                        </a>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 padder-v b-r b-light">
                        ...
                        <a class="clear" href="#">
                            <span class="h3 block m-t-xs"><strong><?php echo e($data['lesson']); ?></strong></span>
                            <small class="text-muted text-uc">Lesson</small>
                        </a>
                    </div>
                        ...
                        <div class="bg-light dk wrapper">
                            ...
                            <div class="text-center m-b-n m-t-sm">
                                ...
                                <div class="sparkline inline" data-type="bar" data-height="45" data-bar-width="6"
                                    data-bar-spacing="6" data-bar-color="#65bd77">10,9,11,10,11,10,12,10,9,10,11,9,8
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                        ...
                        <section class="comment-body m-b-lg">
                            <header>
                                <a href="#"><strong>John smith</strong></a> shared a <a href="#"
                                    class="text-info">video</a> to you
...
<?php echo $__env->make('layouts.admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/admin/domains/intervision.in/public_html/ezlearn/resources/views/page/admin/index.blade.php ENDPATH**/ ?>