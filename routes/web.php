...
Route::get('/linkstorage', function () {
    ...
    return 'Links DONE'; //Return anything
});
...
//language
    ...
    Route::post('checkout/gbpaybackproresult', 'Member\HomeController@gbpaybackproresult');
    Route::post('checkout/gbpaybackproresult_qrcode', 'Member\HomeController@gbpaybackproresult_qrcode');
...
//forgotpassword
    ...
    Route::get('forgotpassword/changepassword/{token_email}', 'Member\ForgotPasswordController@changepassword');
...
//terms & condition
    ...
    Route::get('policy', 'Member\PolicyController@index');
...
//course
    ...
    Route::get('course/{id}', 'Member\CourseController@index');
// Route::get('course/category/{id}/{title}', 'Member\CourseController@category');
    Route::post('course/search', 'Member\CourseController@search_course');
    ...
    Route::get('course/comment_delete/{id}/{course_id}/{title}', 'Member\CourseController@comment_delete');
...
//cart & checkout
    ...
    Route::post('checkout/gbpay', 'Member\CartController@payment_by_gateway');
    Route::post('checkout/gbpay_again', 'Member\CartController@payment_by_gateway_again');

    Route::post('checkout/paynowcredit_gbpay', 'Member\CartController@paynowcredit_gbpay');
    Route::post('checkout/gbpayclientresult', 'Member\CartController@gbpayclientresult');
    Route::post('checkout/get_payment_status', 'Member\CartController@get_payment_status');
...
//wishlist
    ...
    Route::post('mywishlist/addwilish', 'Member\WishlistController@addwilish');
    Route::post('mywishlist/search', 'Member\WishlistController@search');
    Route::get('mywishlist/delete/{id}', 'Member\WishlistController@delete');

//my course
    Route::get('mycourse', 'Member\MyCourseController@index');
    Route::post('mycourse/search', 'Member\MyCourseController@search');
    Route::get('mycourse/addcomment/{userid}/{lesson}/{comment}', 'Member\MyCourseController@addcomment');
    Route::get('mycourse/deletecomment/{commentid}', 'Member\MyCourseController@deletecomment');
    ...
    Route::get('mycourse/testing/{id}/{title}/{step}/{lessonid}', 'Member\MyCourseController@testing_course');
...
// manage course for teacher
    Route::get('managecourse', 'Member\MyManageCourseController@index');
    Route::get('gradebook/{id}', 'Member\MyManageCourseController@getgradebook');
...
Route::get('admin/forgotpassword/changepassword/{token_email}', 'Admin\ForgotPasswordController@changepassword');
...
Route::get('admin/users/{page}/search', 'Admin\UsersController@search');
...
//admin course
Route::get('admin/course/loadquestion/{id}', 'Admin\CourseController@loadquestion');
Route::get('admin/course/loadquestionedit/{id}', 'Admin\CourseController@loadquestionedit');
Route::get('admin/course/loadchoice/{id}', 'Admin\CourseController@loadchoice');
Route::get('admin/course/loadlession/{id}', 'Admin\CourseController@loadlession');
Route::get('admin/course/loadcontentlession/{id}', 'Admin\CourseController@loadcontentlession');
Route::post('admin/course/deletequestion/', 'Admin\CourseController@deletequestion');
Route::post('admin/course/deletechoice/', 'Admin\CourseController@deletechoice');
Route::post('admin/course/deleteimage/', 'Admin\CourseController@deleteimage');
Route::get('admin/course/{page}', 'Admin\CourseController@page');
Route::get('admin/course/{page}/search', 'Admin\CourseController@search');
...
Route::get('admin/products/{page}/search', 'Admin\ProductsController@search');
...
Route::post('admin/content/updatesort', 'Admin\ContentController@updatesort');
...
Route::get('admin/news/{page}/search', 'Admin\NewsController@search');
...
//admin language
Route::get('admin/language/{page}', 'Admin\languageController@page');
Route::get('admin/language/{page}/search', 'Admin\languageController@search');
Route::get('admin/language/{page}/add', 'Admin\languageController@form_add');
Route::get('admin/language/{page}/edit/{id}', 'Admin\languageController@form_edit');
Route::post('admin/language/{page}/action', 'Admin\languageController@action');
Route::get('admin/language/delete/{page}/{id}', 'Admin\languageController@delete');

//admin menusystem
Route::get('admin/menusystem/{page}', 'Admin\MenuSystemController@page');
Route::get('admin/menusystem/{page}/search', 'Admin\MenuSystemController@search');
Route::get('admin/menusystem/{page}/add', 'Admin\MenuSystemController@form_add');
Route::get('admin/menusystem/{page}/edit/{id}', 'Admin\MenuSystemController@form_edit');
Route::post('admin/menusystem/{page}/action', 'Admin\MenuSystemController@action');
Route::get('admin/menusystem/delete/{page}/{id}', 'Admin\MenuSystemController@delete');
Route::get('admin/menusystem/submenu/{id}', 'Admin\MenuSystemController@submenu');
Route::get('admin/menusystem/getdatasubmenu/{id}', 'Admin\MenuSystemController@getdatasubmenu');
