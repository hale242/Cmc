...
<!-- validation -->
<script src="{{asset('assets/admin/plugins/jquery_validate_1_16_0/jquery.validate.min.js')}}"></script>
...
<!-- dropzone -->
<link rel="stylesheet" type="text/css" href="{{asset('assets/admin/plugins/dropzone/dropzone.css')}}">
<script src="{{asset('assets/admin/plugins/dropzone/dropzone.min.js')}}"></script>
{{-- <script src="http://adminshareforce.sellsogood.com/template_admin/libs/dropzone/dist/min/dropzone.min.js"></script> --}}
