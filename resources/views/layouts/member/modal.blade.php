<div class="modal fade" id="payment_credit_card" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="confirm_order_credit" name="confirm_order_transfer" method="post" action="{{url('/checkout/gbpay')}}">
                @csrf
...
<div class="modal fade" id="payment_transfer_free" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="form-group hide">
                <label for="recipient-name" class="col-form-label">Time of payment:</label>
                <input name="payment_time" type="time" class="form-control" value="{{date('H:i:s')}}" required readonly>
            </div>
            <div class="form-group hide">
                <label for="recipient-name" class="col-form-label">Amount:</label>
                <input name="price" id="price_free" type="text" class="form-control" readonly>
            </div>
            <input type="hidden" name="bank_transfer" value="-">
            <input type="file" name="slip_file" class="form-control hide"> --}}
...
$('#confirm_order_transfer').on('submit', function(e){
    ...
    var url_api = "{{url('checkout/transfer')}}";
...
//     e.preventDefault();
//     var formData = new FormData($(this)[0]);
//     var url_api = "{{url('checkout/gbpay')}}";
//     var url_after = "{{url('myorder')}}";
//     $.ajax({
//         type : 'post',
//         url : url_api,
