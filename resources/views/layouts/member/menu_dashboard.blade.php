<style type="text/css">
    ...
    <div class="menu-profile-mobile hidden-sm hidden-md hidden-lg" style="padding:0px; margin:0px;">
        <ul class="list-group" style="margin-bottom:0px;">
            <li class="list-group-item"><a href="{{url('dashboard')}}" class="@if(Request::segment('1')=='dashboard'||Request::segment('1')=='profile') active @endif">Dashboard</a></li>
            <li class="list-group-item"><a href="{{url('mycourse')}}" class="@if(Request::segment('1')=='mycourse') active @endif">My Course</a></li>
            <li class="list-group-item"><a href="{{url('mywishlist')}}" class="@if(Request::segment('1')=='mywishlist') active @endif">My Wishlist</a></li>
            <li class="list-group-item"><a href="{{url('myorder')}}" class="@if(Request::segment('1')=='myorder') active @endif">My Order</a></li>
            @if(session('session_user_type')==3)
                <li><a href="{{url('managecourse')}}" class="@if(Request::segment('1')=='managecourse') active @endif" style="background-color: #0027ff;padding: 17px;">Manage Course</a></li>
            @endif
        </ul>
    </div>
