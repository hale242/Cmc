    ...
    <div class="col-lg-12">
        <table class="table table-striped b-t b-light" cellspacing="0" width="100%">
            ...
            <tbody>
                ...
                @if(file_exists(public_path().'/upload/member/news/images/'.$value->news_image) && $value->news_image !=
                null)
                ...
                <tr>
                    ...
                    <td><a href="{{url('news/detail/'.$value->news_id.'/'.$value->news_title)}}" target="_blank"
                            class="text-info">{{$value->news_title}}</a></td>
                    <td>
                    ...
                    <td>
                        <a href="{{url('admin/news/main/edit/'.$value->news_id)}}" class="btn btn-success"
                            title="Edit"><i class="fa fa-edit"></i></a>
                        <a href="#" class="btn btn-danger"
                            onclick="confirm_delete('{{url('admin/news/delete/news/')}}','{{$value->news_id}}');"
