<div class="row">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" action="{{url('admin/news/'.$data['page'].'/action')}}" method="post"
            ...
            @if(file_exists(public_path().'/upload/member/news/images/'.$data['detail']['news_image']) &&
                    ...
                    <div class="form-group pull-in clearfix">
                        ...
                        <div class="col-sm-8">
                            ...
                            <textarea name="short_content" class="form-control"
                                placeholder="Short Content">{{$short_content}}</textarea>
                        </div>
                        <div class="col-sm-12">
                            <br>
                            <label>Full Content</label>
                            <textarea name="full_content" id="full_content" class="form-control" placeholder="Full Content">{{$full_content}}</textarea>
                        </div>
                        <div class="col-sm-7">
                            <br>
