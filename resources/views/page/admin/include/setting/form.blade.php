    ...
    <div class="basic-elements">
        <form action="{{url('admin/setting/'.$data['page'].'/action')}}" method="post" enctype="multipart/form-data">
            ...
            <input type="hidden" name="id"
                value="@if(isset($data['detail'][0][0])){{$data['detail'][0][0]}}@else{{''}}@endif">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Short Name" required
                            value="{{$name}}">
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label>ชื่อรูป</label>
                        <input name="name" type="text" class="form-control" placeholder="Name Slider" required
                            value="{{$name}}">
                    </div>
                    <div class="form-group">
                        ...
                        <p class="small text-danger">*ขนาดรูปภาพ 1920x600 Size ไม่เกิน 2 mb. || รองรับเฉพาะไฟล์
                            jpeg,jpg,png</p>
                    </div>
                    ...
                    <div class="form-group">
                        <label>สถานะ</label>
                        <br>
                        <input name="status" type="radio" required
                            @if($data['detail']['Sli_Status']==0){{'checked'}}@endif value="0"> Active
                        <input name="status" type="radio" required
                            @if($data['detail']['Sli_Status']==1){{'checked'}}@endif value="1"> In-Active
                    </div>
                    @endif
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label>ชื่อรูป</label>
                        <input name="name" type="text" class="form-control" placeholder="Name Image" required
                            value="{{$name}}">
                    </div>
                    <div class="form-group">
                        ...
                        <img src="{{asset('upload/member/institution/images/cover/'.$data['detail']['Inj_Img'])}}"
                            width="200">
                        @endif
