                                            ...
                                            <div class="col-md-4" style="margin-bottom: 20px">
                                                <div class="row">
                                                    <div class="col-md-3 text-center" style="padding-top: 5px;">
                                                        ...
                                                        {{-- pol --}}
                                                        <img src="{{asset('/upload/profile/'.$data['detail']->image)}}" class="img-teacher">
                                                    </div>
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h4 class="media-heading">
                                                    <a href="{{url('course/detail/'.$value->course_id.'/'.$value->course_name)}}"><b>{{iconv_substr($value->course_name,0,15,'UTF-8')}}</b></a>
                                                </h4>
                                                <span
