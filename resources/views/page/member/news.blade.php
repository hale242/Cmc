              ...
              <div class="col-lg-4 col-md-4 col-xs-12 alert">
                <div class="mu-latest-course-single">
                  <figure class="mu-latest-course-img">
                    <a href="{{url('news/detail/'.$value->news_id.'/'.$value->news_title)}}" style="height: 240px;background: url({{$img}});background-size: cover;background-position: center;">
                  ...
                  <div class="mu-latest-course-single-content">
                    ...
                    <div class="mu-latest-course-single-contbottom">
                      <p class="small">
                      <i class="fa fa-clock-o"></i> {{date("H:i:s",strtotime($value->updated_at))}}
                      </p>
