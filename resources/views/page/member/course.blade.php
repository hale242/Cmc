                        ...
                        @endphp
                            ...
                            <div class="boxchoice">
                                <label for="cbx{{$value->category_id}}" class="label-cbx">
                                    <input id="cbx{{$value->category_id}}" name="choice_pretest[{{$value->category_id}}]" type="checkbox" class="check_cat invisible" value="{{$value->category_id}}" <?php if(isset($data['idcate'][0])){ if($data['idcate'][0]==$value->category_id){ echo "checked"; } } ?> >
                                    <div class="checkbox">
