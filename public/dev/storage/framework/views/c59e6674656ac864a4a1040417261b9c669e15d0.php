            ...
            <tbody>
                ...
                <?php $__currentLoopData = $data['detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <td><?php if($value->order_payment_date!=null): ?><?php echo e($value->order_payment_date); ?><?php else: ?> <?php echo e('-'); ?><?php endif; ?></td>
        ...
        <footer class="panel-footer">
            <div class="row">
                <div class="col-sm-2 text-left">
                    <small
                        class="text-muted inline m-t-sm m-b-sm"><?php if(count($data['detail'])>25): ?><?php echo e('Showing 1-10 of'.count($data['detail']).'items'); ?><?php else: ?><?php echo e('Showing '.count($data['detail']).' items'); ?><?php endif; ?></small>
                </div>
                <div class="col-sm-8">
                </div>
...
<?php /**PATH /home/cmcbiote/public_html/resources/views/page/admin/include/orders/view.blade.php ENDPATH**/ ?>