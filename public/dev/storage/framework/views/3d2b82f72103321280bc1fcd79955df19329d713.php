            ...
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-sm-2 text-left">
                        <small
                            class="text-muted inline m-t-sm m-b-sm"><?php if(count($data['detail'])>10): ?><?php echo e('Showing 1-10 of'.count($data['detail']).'items'); ?><?php else: ?><?php echo e('Showing '.count($data['detail']).' items'); ?><?php endif; ?></small>
                    </div>
                    <div class="col-sm-8">
                    </div>
...
<?php endif; ?>
<?php /**PATH /home/cmcbiote/public_html/resources/views/page/admin/include/course/view.blade.php ENDPATH**/ ?>