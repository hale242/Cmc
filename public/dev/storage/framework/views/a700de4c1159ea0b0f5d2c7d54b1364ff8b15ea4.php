...
<?php $__currentLoopData = $data['detail']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="col-md-4 col-sm-4">
        <div class="mu-latest-course-single hvr-float-shadow">
            ...
            <div class="mu-latest-course-single-content" style="padding-top: 35px;">
                ...
                <h6 style="color:#949494;"><?php echo e($teacher_name); ?></h6>
                <h4 style="padding-top:10px;margin-bottom:10px;height: 40px;">
...
<?php else: ?>
    ...
    <?php endif; ?>
<?php /**PATH /home/cmcbiote/public_html/resources/views/page/member/ajax/course/detail.blade.php ENDPATH**/ ?>