                        <div class="row">
                            ...
                            <table class="table table-striped b-t b-light"  cellspacing="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td><a href="<?php echo e(url('news/detail/'.$value->news_id.'/'.$value->news_title)); ?>" target="_blank" class="text-info"><?php echo e($value->news_title); ?></a></td>
                                    <td>
                                    ...
                                    <td>
                                    <a href="<?php echo e(url('admin/news/main/edit/'.$value->news_id)); ?>" class="btn btn-success" title="Edit"><i class="fa fa-edit"></i></a>
                                    <a href="#" class="btn btn-danger" onclick="confirm_delete('<?php echo e(url('admin/news/delete/news/')); ?>','<?php echo e($value->news_id); ?>');" title="Delete"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
