...
class ProfileController extends Controller
{
    ...
    public function form($page)
    {
        ...
        return view('page.admin.profile', ['data' => $data, 'userinfo' => $this->userinfo()]);
        ...
        if ($request->post()) {
            ...
            if ($page == 'ChangeProfile') {
                ...
                if (isset($request->img)) {
                    ...
                    $file_upload = ['filename' => $_FILES['img']['name'], 'tmp_name' => $_FILES['img']['tmp_name'], 'folder' => 'upload/profile', 'width' => 0, 'height' => 0];
