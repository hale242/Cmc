            ...
            $.get(url_div,function(data){
                $.each(data, function(k, v) {
                    ...
                    $("#lesson_file").append('<div class="col-md-4">'+
                        '<a target="_blank" data-fancybox="gallery_lession'+v['lesson_id']+'" style="border: 1px solid #ccc;padding: 5px;margin-right: -8px;margin-bottom: 5px;" href="{{asset('upload/member/lesson/file/')}}/'+v['lesson_file']+'">'+namefile+'</a>&nbsp;&nbsp;'+
