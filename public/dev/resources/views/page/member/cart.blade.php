                        ...
                        <div class="col-md-9">
                            ...
                            <form action="{{url('cart/update')}}" method="post">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                <div class="col-md-9">
                                                    <p><b>{{Str::words($item->name,20)}}</b>
                                                        ...
                                                        @endphp
                                                        <small style="color:#aaaaaa;">{{iconv_substr($detail->course_short_description,0,100,'UTF-8').$dots}}</small>
                                                    </p>
                                                </div>
                                            </td>
                                            ...
                                            <td class="text-info" align="center">
                                                ...
                                                <input type="hidden" autocomplete="off" minlength="1" readonly
                                                    name="qty[<?php echo $item->id;?>]" value="{{$item->quantity}}">
                                            </td>
                                            <td class="text-info" align="center">฿
                                ...
                                <div class="col-md-5" align="right">
                                    ...
                                    <a href="{{url('cart/clear')}}" class="btn btn-warning"
                        ...
                        <div class="col-md-3">
                            ...
                            <div style="background-color: #ebebeb; border-radius: 6px; padding:10px; height: 280px;">
                                ...
                                <div class="col-md-12 alert" align="left">
                                    <a href="{{url('checkout')}}" class="btn btn-danger btn-lg"
