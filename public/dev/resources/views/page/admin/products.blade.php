    ...
    <section class="vbox">
        <section class="scrollable padder">
            ...
            <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                ...
                <li class="active"><a href="{{url('admin/products/'.strtolower($data['page']))}}">{{$data['page']}}</a>
                </li>
            </ul>
            @if($data['page']=='Main')<?php $title = 'Products';?>@else<?php $title = $data['page'];?>@endif
            <div class="m-b-md">
                        ...
                        <section class="panel panel-default">
                            ...
                            <div class="row wrapper">
                                ...
                                <div class="col-lg-12 text-right">
                                    <a href="{{url('admin/products/'.strtolower($data['page']).'/add')}}"
                                        class="btn btn-primary" title="Add"><i class="fa fa-plus"></i> Create</a>
                                </div>

                                <br><br><br>

                                <form action="{{url('admin/products/'.$data['page']).'/search'}}" method="get"
                                    ...
                                    <div class="col-sm-12 m-t">
                                        <div class="col-sm-12">
                                            ...
                                            <a href="{{url('admin/products/'.strtolower($data['page']))}}">
                            ...
                            <div class="table-responsive">
                                @if($data['type']=='view')
                                @include('page.admin.include.products.view')
                                @elseif($data['type']=='form')
                                @include('page.admin.include.products.form')
                                @else
                                @include('page.admin.include.products.show')
                                @endif
                            </div>
                        </section>
                </div>
