<div class="row">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" action="{{url('admin/products/'.$data['page'].'/action')}}" method="post"
            ...
            @if(file_exists(public_path().'/upload/member/product/images/'.$data['detail']['product_image']) &&
            ...
            @if(isset($data['detail']['product_short_desc']))
                    ...
                    <div class="form-group pull-in clearfix">
                        ...
                        <div class="col-sm-7 m-t">
                            ...
                            <textarea name="product_short_desc" id="product_short_desc" cols="30" rows="5"
                                class="form-control" required>{{$detail_short}}</textarea>
                        </div>
                        <div class="col-sm-12">
                            <br>
